...
class PodcastActivity : AppCompatActivity(), PodcastListAdapterListener,
    ...
    //pg 500
    companion object {
        private const val TAG_DETAILS_FRAGMENT = "DetailsFragment"                                  //Used to hold the podcast details view data                                 //Tag to identify the details Fragment in the Fragment Manager
        //pg 568
        private const val TAG_EPISODE_UPDATE_JOB = "com.raywenderlich.podplay.episodes"             //Defines a name for the work request
        //pg 619
