...
class EpisodePlayerFragment : Fragment() {
    ...
    //pg 587
    private fun startPlaying(                                                                       //Use media controller transport controls to initiate the media playback
    ...
    //pg 582
    private fun initMediaBrowser() {                                                                //Instantiate a new MediaBrowserCompat object
        val fragmentActivity = activity as FragmentActivity
    ...
    private fun registerMediaController(token: MediaSessionCompat.Token) {
        val fragmentActivity = activity as FragmentActivity                                         //Assign to activity
        val mediaController = MediaControllerCompat(fragmentActivity, token)                        //Create MediaController and associate with the session token. Connects media controller with the media session

        MediaControllerCompat.setMediaController(fragmentActivity, mediaController)                 //assign media controller with the activity
